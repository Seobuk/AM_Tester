...
class CAMCONTROLCtrl : public ITcOCFCtrlImpl<CAMCONTROLCtrl, CAMCONTROLClassFactory>
{
public:
	CAMCONTROLCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("AMCONTROL: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CAMCONTROLCtrl>;
